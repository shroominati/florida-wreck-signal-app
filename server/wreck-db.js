...
const LAND_FIND_ZONES = [
  ...
  {
    id: "land-lignumvitae-matecumbe",
    name: "Lignumvitae / Lower Matecumbe",
    lat: 24.8572,
    lon: -80.7486,
    regionKey: "keys",
    areaTags: ["keys", "upper-keys", "lower-matecumbe", "lignumvitae", "islamorada"],
    beachRetention: 0.46,
    duneRetention: 0.41,
    stormWashover: 0.49,
    renourishmentRisk: 0.09,
    publicAccess: 0.11,
    historySignal: 0.83,
    landformSignal: 0.86,
    legalSensitivity: "high",
    findingType: "higher-key occupation landscape",
    coordinateBasis: "Approx public-study center based on Lower Matecumbe and Lignumvitae heritage references.",
    terrainSignals: ["higher-key hammock ground", "black-earth midden signatures", "protected burial-context literature"],
    searchNote:
      "Higher-key protected landscape tied to Keys occupation and early historic movement, useful for records work and professional survey planning rather than casual searching.",
  },
  {
  ...
  {
    id: "land-gleason-indian-harbour",
    name: "Gleason Park / Indian Harbour Remnant",
    lat: 28.1487,
    lon: -80.5929,
    regionKey: "space-coast",
    areaTags: [
    ...
    duneRetention: 0.68,
    stormWashover: 0.57,
    renourishmentRisk: 0.16,
    publicAccess: 0.26,
    historySignal: 0.84,
    landformSignal: 0.78,
    legalSensitivity: "high",
    findingType: "barrier-remnant settlement corridor",
    coordinateBasis: "Approx public-study center based on Indian Harbour Beach and Gleason Park barrier-remnant references.",
    terrainSignals: ["barrier remnant surfaces", "lagoon-facing occupation edge", "truncated midden signatures"],
    searchNote:
      "Opposite-side barrier remnant paired with the Eau Gallie / Pentoaya literature, useful as protected historical context rather than a public search beach.",
  },
  {
  ...
  {
    id: "land-seminole-rest-ross-hammock",
    name: "Seminole Rest / Ross Hammock",
    lat: 28.8723,
    lon: -80.8891,
    regionKey: "daytona-coast",
    areaTags: ["daytona-coast", "volusia", "seminole-rest", "ross-hammock", "mosquito-lagoon", "new-smyrna"],
    beachRetention: 0.71,
    duneRetention: 0.79,
    stormWashover: 0.6,
    renourishmentRisk: 0.07,
    publicAccess: 0.18,
    historySignal: 0.88,
    landformSignal: 0.92,
    legalSensitivity: "high",
    findingType: "lagoon refuge and mound corridor",
    coordinateBasis: "Approx public-study center based on the Seminole Rest and Ross Hammock literature.",
    terrainSignals: ["lagoon refuge hammocks", "shell ridge margins", "protected estuarine occupation surfaces"],
    searchNote:
      "Protected Mosquito Lagoon refuge corridor centered on Seminole Rest and Ross Hammock, with strong public preservation literature.",
  },
  {
...
const CURATED_LAND_BRIEF_JOURNALS = [
  ...
  {
    id: "journal-land-brief-lignumvitae",
    title: "Lower Matecumbe and Lignumvitae reinforce the higher-key heritage pattern",
    year: 2026,
    sourceLabel: "Curated from florida_land_onshore_prediction_brief.docx",
    sourceId: "land-brief-lignumvitae",
    verificationStatus: "curated-summary",
    areaTags: ["keys", "upper-keys", "lower-matecumbe", "lignumvitae", "islamorada"],
    cargoProfile: "protected Keys occupation and burial-context landscape",
    confidence: 0.83,
    excerpt:
      "Curated summary: Lignumvitae and nearby higher keys reinforce the broader pattern that protected occupation, midden, and burial contexts are the dominant land-side Keys signal rather than inland treasure caching.",
  },
  {
  ...
  {
    id: "journal-land-brief-gleason",
    title: "Indian Harbour Beach and Gleason Park preserve the opposite barrier-remnant side of Pentoaya",
    year: 2026,
    sourceLabel: "Curated from florida_land_onshore_prediction_brief.docx",
    sourceId: "land-brief-pentoaya",
    verificationStatus: "curated-summary",
    areaTags: ["space-coast", "indian-harbour-beach", "gleason-park", "eau-gallie", "ballard-park", "pentoaya"],
    cargoProfile: "barrier-remnant and midden-truncation signal",
    confidence: 0.82,
    excerpt:
      "Curated summary: the opposite barrier-remnant side of the Eau Gallie / Pentoaya corridor remains important because shoreline occupation and later truncation signatures cluster there as well.",
  },
  {
    id: "journal-land-brief-seminole-rest-ross",
    title: "Seminole Rest and Ross Hammock are the clearest refuge nodes within the Mosquito Lagoon belt",
    year: 2026,
    sourceLabel: "Curated from florida_land_onshore_prediction_brief.docx",
    sourceId: "land-brief-seminole-rest",
    verificationStatus: "curated-summary",
    areaTags: ["daytona-coast", "volusia", "seminole-rest", "ross-hammock", "mosquito-lagoon", "new-smyrna"],
    cargoProfile: "shell ridge and refuge-hammock landscape",
    confidence: 0.86,
    excerpt:
      "Curated summary: Seminole Rest and Ross Hammock are the clearest public-study refuge nodes in the Mosquito Lagoon literature, distinct from the larger Turtle Mound landmark but part of the same preserved estuarine system.",
  },
];
...
function inferAreaTags(text, regionHint = "") {
  ...
  const lookups = [
    ...
    { tags: ["keys", "upper-keys", "lower-matecumbe", "lignumvitae", "islamorada"], pattern: /(lower matecumbe|lignumvitae)/ },
